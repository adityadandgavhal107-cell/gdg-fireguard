  ...
  return (
    <div className="daf-app" style={{ height: '100vh', display: 'flex', flexDirection: 'column', background: '#0a0505', color: '#fff', fontFamily: 'Inter, sans-serif' }}>
      ...
      <style>{`
        ...
        .tactical-stat .label { fontSize: 8px; color: rgba(255,255,255,0.3); fontWeight: 900; letterSpacing: 1; margin-bottom: 2px; }
        .tactical-stat .val { fontSize: 20px; fontWeight: 900; color: #ff2d2d; font-family: 'JetBrains Mono'; letterSpacing: 1; }
